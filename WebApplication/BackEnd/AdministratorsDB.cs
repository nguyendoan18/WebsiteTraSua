...
namespace WebApplication.BackEnd
{
    public class AdministratorsDB
    {
        ...
        public List<Users> ListAll()
        {
            ...
            {
                con.Open();
                SqlCommand com = new SqlCommand("SelectUserstabledata", con);
                ...
                while (rdr.Read())
                {
                    lst.Add(new Users
                    {
                        ...
                        username = rdr["username"].ToString().Replace(" ", ""),
                        password = rdr["password"].ToString().Replace(" ", ""),
                    });
                }
                return lst;
            }
        ...
        public int Delete(int Id)
        {
            ...
            {
                con.Open();
                SqlCommand com = new SqlCommand("AdminDBDelete", con);
                com.CommandType = CommandType.StoredProcedure;
